...
exports.string = function (opt) {
    ...
    f.labelHTML = function (name, id) {
        ...
        if (typeof this.cssClasses !== 'undefined' && 'label' in this.cssClasses && Array.isArray(this.cssClasses.label) && this.cssClasses.label.length > 0) {
    ...
    f.classes = function () {
        ...
        if (typeof this.cssClasses !== 'undefined' && 'field' in this.cssClasses && Array.isArray(this.cssClasses.field) && this.cssClasses.field.length > 0) {
            r.push(this.cssClasses.field.join(' '));
        }
        return r;
    };
