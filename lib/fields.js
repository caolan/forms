...
exports.string = function (opt) {
    ...
    f.labelText = function (name) {
        var nameParts = name ? name.replace(/\]/g, '').split(/\[/) : [],
            labelName = nameParts.length > 0 ? nameParts[nameParts.length - 1] : '';
        return this.label || (labelName ? labelName[0].toUpperCase() + labelName.substr(1).replace(underscoreRegExp, ' ') : '');
    };
