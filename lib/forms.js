...
exports.loadLocale = function (locale) {
    return require('./locale/'+locale).messages;
};
...
exports.create = function (fields) {
    ...
    var f = {
        ...
        bind: function (data) {
            ...
            b.validate = function (callback, opts) {
        ...
        handle: function (obj, callbacks, opts) {
            if (typeof obj === 'undefined' || obj === null || (typeof obj === 'object' && Object.keys(obj).length === 0)) {
                ...
                if (obj.method === 'GET') {
                    f.handle(parse(obj.url, 1).query, callbacks, opts);
                    ...
                    if (obj.body) {
                        f.handle(obj.body, callbacks, opts);
                    } else {
                        var buffer = '';
                        ...
                        obj.addListener('end', function () {
                            f.handle(querystring.parse(buffer), callbacks, opts);
                        });
                    }
                } else {
