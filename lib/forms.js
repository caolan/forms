...
exports.sanitisers = require('./sanitisers');
...
exports.create = function (fields) {
    var f = {
        ...
        bind: function (data) {
            ...
            b.sanitise = function (callback) {
	        	 async.forEach(Object.keys(b.fields), function (k, callback) {
		        	b.fields[k].sanitise(b, function (err, bound_field) {
        ...
        handle: function (obj, callbacks) {
            if (typeof obj === 'undefined' || obj === null || (typeof obj === 'object' && Object.keys(obj).length === 0)) {
            	...
            	var fb = f.bind(obj);
            	fb.sanitise(function(){
	            	fb.validate(function (err, f) {
	                    if (f.isValid()) {
